    ...
    def minimax(self, game, depth, maximizing_player=True):
        ...
        **********************************************************************
        ...
        if self.time_left() < self.TIMER_THRESHOLD:
            raise SearchTimeout()
        #Modify the `MinimaxPlayer.minimax()` method to return any legal move for the active player, return (-1,-1) if there are no legal moves
...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def get_move(self, game, time_left):
        ...
        **********************************************************************
        ...
        # Did we just start the game? Then,select center position.
        ...
        try:
            ...
            # The try/except block will automatically catch the exception
            while True:
                best_score, best_move = self.alphabeta(game, iterative_search_depth)
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf"), maximizing_player=True):
        ...
        **********************************************************************
        ...
        if not legal_moves:
            ...
            return game.utility(self), (-1, -1)
        if depth == 0:
            #if no more layers, return score from max player's pov
            return self.score(game, self), (-1, -1)
        if maximizing_player:
            # Best for maximizing player is highest score
            best_score = float("-inf")
